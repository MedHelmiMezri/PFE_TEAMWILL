      ...
      <div ref="addTopic">
        <div class="row justify-evenly col-6 col-md-6 flex wrap">
          <q-card bordered v-bind:style="$q.screen.lt.sm ? {'width': '40%'} : {'width': '70%'}" >
            <q-bar dense style="height: 15px; background-color: #07C7FA;">
            </q-bar>
            <q-card-section>
              <q-avatar size="8rem" class="absolute-center shadow-10">
                    <q-icon name="list"/>
              </q-avatar>
            </q-card-section>
            <q-card-section>
...
<!--                    <q-select
                    ...
                    <div class="row justify-end">
                      <q-btn label="Create Task"
                             class="col-md-5"
                             style="background-color: #07C7FA;"
                             glossy
                             type="submit"/>
                    </div>
                  </div>
