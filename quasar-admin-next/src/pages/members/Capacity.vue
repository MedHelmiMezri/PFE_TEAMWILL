      ...
      <q-separator style="margin-bottom: 16px;"></q-separator>
        ...
        >
          <template v-slot:top-right="props">
            <q-input  style="padding: 20px;" outlined dense debounce="300" v-model="filter" placeholder="Search">
          ...
          <template v-slot:body-cell-action="props">
            <q-td :props="props">
              <div class="q-gutter-sm">
                <q-btn push  dense color="primary" icon="edit"/>
                <q-btn push dense  color="red" icon="delete"/>
